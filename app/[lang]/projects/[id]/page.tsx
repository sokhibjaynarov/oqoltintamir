  ...
  try {
    ...
    const projects = {
      "1": {
        ...
        details: {
          type: lang === "uz" ? "Umumqurilish-ijtimoiy" : lang === "ru" ? "Общестроительные и социальные объекты" : "General Construction & Social Facilities",
      ...
      "2": {
        ...
        details: {
          type: lang === "uz" ? "Melioratsiya va irrigatsiya" : lang === "ru" ? "Мелиорация и ирригация" : "Land Reclamation & Irrigation",
          location: lang === "uz" ? "Toshkent markazi" : lang === "ru" ? "Центр Ташкента" : "Tashkent Center",
          area: lang === "uz" ? "2,500 m²" : lang === "ru" ? "2,500 м²" : "2,500 м²",
      ...
      "3": {
        ...
        details: {
          type: lang === "uz" ? "Katta quvvatdagi Elektr tarmoqlari va Qurulmalarini qurish" : lang === "ru" ? "Строительство высоковольтных электрических сетей и оборудования" : "High-Voltage Electrical Networks & Equipment Construction",
          location: lang === "uz" ? "Toshkent viloyati" : lang === "ru" ? "Ташкентская область" : "Tashkent Region",
          area: lang === "uz" ? "8,000 m²" : lang === "ru" ? "8,000 м²" : "8,000 м²",
